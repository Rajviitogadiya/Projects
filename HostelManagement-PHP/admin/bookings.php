        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h2 class="page-title text-truncate text-dark font-weight-medium mb-1">Hostel Bookings</h2>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="customRadio1">Required <code>Extra Rs.211 Per Month</code></label>
                                </div>
                                <div class="custom-control custom-radio">
